...
public final class documentMgr_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("                            $.ajax({  \r\n");
      out.write("                                url : \"/document/documentTree/ajaxTree\",  \r\n");
      ...
      out.write("        \r\n");
      out.write("        \t//公共文件夹\r\n");
      out.write("        \tif(data.group_type=='0'){       \t\t\r\n");
      out.write("        \t\t//只读文件夹\r\n");
      out.write("        \t\tif(data.readOnly=='0')\r\n");
      out.write("        \t\t{\r\n");
      out.write("        \t\t\tx.src = \"docDetail.jsp?pageCode=DOC_DIRECTORY_SELECT&menuCode=READ&_dataSourceCode=DOC_DIRECTORY_SELECT&ParentPKField=&ParentPKValue=\"+data.id+\"&isReadonly=1\";\r\n");
      out.write("        \t\t}else\r\n");
      out.write("        \t\t{\r\n");
      out.write("        \t\t\tx.src = \"docDetail.jsp?pageCode=DOC_DIRECTORY_SELECT&menuCode=MGR&_dataSourceCode=DOC_DIRECTORY_SELECT&ParentPKField=&ParentPKValue=\"+data.id+\"&isReadonly=1\";\r\n");
      out.write("        \t\t}\r\n");
      out.write("        \t}else\r\n");
      out.write("        \t{\r\n");
      out.write("        \t\t//个人文件夹\r\n");
      out.write("        \t\t\tx.src = \"docDetail.jsp?pageCode=DOC_DIRECTORY_SELECT&menuCode=PER&_dataSourceCode=DOC_DIRECTORY_SELECT&ParentPKField=&ParentPKValue=\"+data.id+\"&isReadonly=1\";\r\n");
      out.write("        \t}\r\n");
      out.write("        }\r\n");
      out.write("        \r\n");
