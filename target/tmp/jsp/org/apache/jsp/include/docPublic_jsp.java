...
public final class docPublic_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("var isBuildButtonByFile = true ; //æ¯å¦å¼å¯jsæä»¶è°è¯æ¨¡å¼,true :jsæä»¶è·åæé®  ï¼ false:æ°æ®åºè·åå·²æææé®ï¼\r\n");
      ...
      out.write("}\r\n");
      out.write("\r\n");
      out.write("function mySave(t)\r\n");
      out.write("{\r\n");
      out.write("\tvar dirname='");
      out.print(request.getParameter("DIRNAME")!=null?request.getParameter("DIRNAME"):"");
      out.write("';\r\n");
      out.write("\t$(\"#DIRECTORY_ID\").val(ParentPKValue);\r\n");
      out.write("\t$(\"#DIRECTORY_NAME\").val(dirname);\r\n");
      out.write("\t//save(t);\r\n");
      out.write("\t\r\n");
      out.write("\tvar message =\"\";\r\n");
      out.write("\talert(getJson($(\"#insPage\")));\r\n");
      out.write("\tmessage = transToServer(findUrlByAuthSave(t),getJson($(\"#insPage\")));\r\n");
      ...
      out.write("\r\n");
      out.write("</script>\r\n");
      out.write("<script src=\"../js/douPublic.js\"></script>\r\n");
      ...
      out.print(request.getParameter("ParentPKValue")!=null?request.getParameter("ParentPKValue"):"");
      out.write("\"/>\r\n");
      out.write("<input type=\"hidden\" id=\"directoryName\" value=\"");
      out.print(request.getParameter("DIRNAME")!=null?request.getParameter("DIRNAME"):"");
      out.write("\"/>\r\n");
      out.write("\r\n");
