...
<%
      ...
      selectMap = RmDictReferenceUtil.getDictReference("BUSFILETYPE");  
   ...
   var messageyw="";      
            ...
            $('#jstree_div').jstree({  
                'core' : {  
                    ...
                    "data" : function (obj, callback){  
                            $.ajax({                   //ajaxTree   authDocumentTree  fzmessage
                                url : "/document/documentTree/fzmessage?token="+token+"&id="+userId, 
                                dataType : "json",  
                                type : "GET",  
        ...
        function toDetail(data){
        	...
        	}else
        	{
        		...
        		if(!yz.test(data.id)){
        		 var bm=data.id;
        		 x.src = "demoSuper.jsp?pageCode=DOC_DOCUMENT_SELECT&menuCode=SUPER&ParentPKField=DIRECTORY_ID&ParentPKValue="+data.id+"&opts="+"0002"+"&token="+token+"&ywcode="+bm;
        		}
        		else{
