...
;! function(t) {
	...
	var e = function(t) {
		...
		function e(e, o) {
			...
			delete o.right,
			delete o.rightAll,
			delete o.rightSelected, this.options = {
				keepRenderingSort : o.keepRenderingSort
			},
			delete o.keepRenderingSort, this.callbacks = o, this.undoStack = [], this.redoStack = [], this.init()
		}
		return e.prototype = {
			init : function() {
				var e = this;
				e.options.keepRenderingSort && (e.skipInitSort = !0, e.callbacks.sort = function(e, o) {
					...
					t(o).data("position", e)
				})), "function" == typeof e.callbacks.startUp && e.callbacks.startUp(e.left, e.right), e.skipInitSort || "function" != typeof e.callbacks.sort || (e.left.find("option").sort(e.callbacks.sort).appendTo(e.left), e.right.find("option").sort(e.callbacks.sort).appendTo(e.right)), e.events(e.actions)
			},
			events : function(e) {
				var o = this;
				o.left.on("dblclick", "option", function(t) {
					t.preventDefault(), o.moveToRight(this)
				}), o.right.on("dblclick", "option", function(t) {
					t.preventDefault(), o.moveToLeft(this)
				}), o.right.closest("form").on("submit", function() {
					o.right.children().attr("selected", !0)
					...
					t.preventDefault(), o.undo()
				}), e.redo.on("click", function(t) {
					t.preventDefault(), o.redo()
				})
			},
			moveToRight : function(t, e, o) {
				var n = this;
				return "function" != typeof n.callbacks.beforeMoveToRight || e || n.callbacks.beforeMoveToRight(n.left, n.right, t) ? (n.right.append(t), o || (n.undoStack.push(["right", t]), n.redoStack = []), "function" != typeof n.callbacks.sort || e || n.right.find("option").sort(n.callbacks.sort).appendTo(n.right), "function" != typeof n.callbacks.afterMoveToRight || e || n.callbacks.afterMoveToRight(n.left, n.right, t), n) : !1
			},
			moveToLeft : function(t, e, o) {
				var n = this;
				return "function" != typeof n.callbacks.beforeMoveToLeft || e || n.callbacks.beforeMoveToLeft(n.left, n.right, t) ? (n.left.append(t), o || (n.undoStack.push(["left", t]), n.redoStack = []), "function" != typeof n.callbacks.sort || e || n.left.find("option").sort(n.callbacks.sort).appendTo(n.left), "function" != typeof n.callbacks.afterMoveToLeft || e || n.callbacks.afterMoveToLeft(n.left, n.right, t), n) : !1
			},
			undo : function() {
				var t = this, e = t.undoStack.pop();
				if (e)
					switch(t.redoStack.push(e),e[0]) {
					case"left":
						t.moveToRight(e[1], !1, !0);
						break;
					case"right":
						t.moveToLeft(e[1], !1, !0)
					}
			},
			redo : function() {
				var t = this, e = t.redoStack.pop();
				if (e)
					switch(t.undoStack.push(e),e[0]) {
					case"left":
						t.moveToLeft(e[1], !1, !0);
						break;
					case"right":
	...
	t.multiselect = {
		...
		return this.each(function() {
			var n = t(this), i = n.data(), l = t.extend({}, t.multiselect.defaults, t.multiselect.setup, i, o);
			return new e(n, l)
		})
	}
}); 