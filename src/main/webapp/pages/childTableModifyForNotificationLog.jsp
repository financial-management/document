		...
		<div class="panel panel-primary">
			...
			<div class="panel-body" id="bulidPage" >
				...
				<ul id="myTab" class="nav nav-tabs">
					<li class="active">
						<a href="#left" data-toggle="tab"><%=pageNames%></a>
					</li>
				</ul>
				...
				<div class="col-md-12">
					<div class="tab-content">
						<div class="tab-pane fade in active" id="left">
					    	<iframe id="leftPage"  width="100%"  scrolling="no" frameborder="0"  height="650px" src="singleTableModify.jsp?pageCode=<%= pageCodes %>&pageName=<%=pageNames%>&initTableParam=<%=initTableParam%>&token=<%=token%>"></iframe>
					    </div>
					</div>
				</div>
			</div>
