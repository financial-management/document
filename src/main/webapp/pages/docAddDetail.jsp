...
<html lang="zh-cn">
	...
	<jsp:include page="../include/docPublic.jsp"></jsp:include>
	...
	function savaByQuery1(t,_dataSourceCode,$div){
		...
		message = transToServer(findUrlByDirectory(),getJson($div));
...
function savaByQuery(t,_dataSourceCode,$div){
	...
	//oTable.showModal('modal', message);
	//setReadonlyByDiv($("#insPage input[type='text']"));
	//alert(_dataSourceCode)
	//setTimeout("back()",1500);
	//alert("5");
	//back();
	alert(message);
	window.parent.location.reload();
	//queryTableByDataSourceCode("",_dataSourceCode);
}
